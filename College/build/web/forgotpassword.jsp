                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="mbr-header mbr-header--center mbr-header--std-padding">
                            <h2 class="mbr-header__text">Get Your Password</h2>
                        </div>
                        
                        <form action="forgot_password.jsp" method="post">
                            <div class="form-group" style="position: relative;">
                                <input type="text" class="form-control" name="name" required="" placeholder="Username or Email">
                                <img border="0" src="assets\images\login.png"   alt="login_icon" width="35" height="35" style="position: absolute; top: 8px; right: 5px;">
                            </div>  
                            <div class="form-group" style="position: relative;">
